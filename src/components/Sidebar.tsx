...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 shrink-0 flex-col border-r border-border bg-bg-surface transition-transform duration-200 md:sticky md:top-0 md:z-30 md:h-screen md:translate-x-0 ${
